        ...
        do {
            ...
            switch (userChoice) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    patronManaging.removePatron(scanner); // Removes a patron.
                    break;
                case 4:
                    patronManaging.viewAllPatrons(); // View all patrons.
                    break;
                case 5:
                    System.out.println("Thank you for using the LMS application. Goodbye!"); // Message when user chooses to close application.
                    break;
                default:
